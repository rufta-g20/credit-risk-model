...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Error: data.csv not found. Please ensure it is in the data/raw/ directory.")
        exit()
    ...
    try:
        ...
        print(f"Model '{best_model_name}' (Version {latest_version.version}) transitioned to 'Staging' in MLflow Model Registry.")
